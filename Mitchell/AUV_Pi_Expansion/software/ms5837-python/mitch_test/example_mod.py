#Mitch edit that trys using the expander
#I think this uses python2 while the tca expander code is circuit python3, might need some help
...
sensor = ms5837.MS5837_30BA(tca[5]) # Default I2C bus is 1 (Raspberry Pi 3)
