...
if IPAddress("192.168.137.50") in IPNetwork("192.168.0.0/24"):
    prGreen('PASS')
else:
    prRed('FAIL')

print('Back Pi Zero Camera .51 ..............', end='')
if IPAddress("192.168.137.51") in IPNetwork("192.168.0.0/24"):
    prGreen('PASS')
else:
    prRed('FAIL')

print('Bottom Pi Zero Camera .52 ..............', end='')
if IPAddress("192.168.137.52") in IPNetwork("192.168.0.0/24"):
    prGreen('PASS')
else:
    prRed('FAIL')
...
print('\nMotor Tests')
sp2 = subprocess.Popen(['', '32432'], stdout=subprocess.PIPE) # execute the command using Popen
try:
